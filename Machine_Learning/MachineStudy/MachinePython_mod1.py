...
# #Importo o arquivo com os dados para serem analisados/Manipulados
# dataset = pd.read_csv('../Data.csv')
# #leio todos os dados de todas as colunas menos a ultima coluna
# x = dataset.iloc[:, :-1].values
# #leio apenas a ultima coluna
